...
export const PLUGINS = Object.freeze([
    ...
    bundle: { selectable: true, defaultLabel: '工作流编辑', aliases: ['flowedit'], dependencies: [], conflicts: [], scope: 'workspace' } },
  {
    ...
    clientFile: 'plugins/theme-teal/client.js',
    note: '主题插件：纯 Client（注入 CSS 变量），按需手动激活一个；停止即回默认主题',
    idPrefixSharedGroup: 'themes',
    bundle: { selectable: true, defaultLabel: '主题·青绿', aliases: ['theme-teal'], dependencies: [], conflicts: ['theme-amber'], scope: 'process' },
  },
  {
    ...
    clientFile: 'plugins/theme-amber/client.js',
    note: '主题插件：纯 Client（注入 CSS 变量），按需手动激活；停止即回默认主题',
    idPrefixSharedGroup: 'themes',
    bundle: { selectable: true, defaultLabel: '主题·暖橙', aliases: ['theme-amber'], dependencies: [], conflicts: ['theme-teal'], scope: 'process' },
  },
