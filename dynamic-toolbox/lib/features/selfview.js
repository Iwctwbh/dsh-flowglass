// ===== 工具箱 · selfview 原生静态 Host 组件（构建生成，勿手改） =====
import { defineTool } from '@deepseek-ai/dsh-tools'

export const name = "dsh-dynamic-toolbox/feature/selfview"
export const inject = ["fs","subprocess","timer","toolboxRegistryDynamicToolbox","toolboxNativeBridgeDynamicToolbox","tools"]
...
export async function apply(ctx) {
  ...
  try {
    ...
    console.log(TOOLBOX_RUNTIME.logTag() + ' 原生静态组件已加载: selfview')
  } finally {
