// ===== 工具箱 · search 原生静态 Host 组件（构建生成，勿手改） =====


export const name = "dsh-dynamic-toolbox/feature/search"
...
export async function apply(ctx) {
  ...
  try {
    ...
    console.log(TOOLBOX_RUNTIME.logTag() + ' 原生静态组件已加载: search')
  } finally {
