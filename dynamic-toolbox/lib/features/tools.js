// ===== 工具箱 · tools 原生静态 Host 组件（构建生成，勿手改） =====


export const name = "dsh-dynamic-toolbox/feature/tools"
export const inject = ["fs","tools","systemPrompt","timer","toolboxRegistryDynamicToolbox"]
...
export async function apply(ctx) {
  ...
  try {
    ...
    console.log(TOOLBOX_RUNTIME.logTag() + ' 原生静态组件已加载: tools')
  } finally {
